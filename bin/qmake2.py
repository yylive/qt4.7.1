...
def _cure_sln(filelines):
    ...
    return ['Microsoft Visual Studio Solution File, Format Version 12.00', '# Visual Studio 2013'] + [line for line in filelines][startIndex:]
