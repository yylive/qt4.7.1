...
qreal QRuntimePixmapData::devicePixelRatio() const
{
	return m_data->devicePixelRatio();
}


void QRuntimePixmapData::setDevicePixelRatio(qreal scaleFactor)
{
	m_data->setDevicePixelRatio(scaleFactor);
}
...
HDC QRuntimeWindowSurface::getDC() const
{
	return m_windowSurface->getDC();
}
