                                   ...
                                   const QTextCharFormat &charFormat)
{
    ...
    if (underlineStyle == QTextCharFormat::WaveUnderline) {
		...
		//[YY.comment]
		//Increase the distance of the dotLine and text
		qreal yyUnderlinePos = underlinePos;
		if ( QTextCharFormat::DotLine == underlineStyle )
		{
			yyUnderlinePos += 2;
		}
        
		QLineF underLine(line.x1(), yyUnderlinePos, line.x2(), yyUnderlinePos);
