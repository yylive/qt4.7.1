...
public:
    ...
    bool drawBackgroundThruNativeBuffer(XPThemeData &themeData, int additionalDevicePixelRatio);
    bool drawBackgroundDirectly(HDC dc, XPThemeData &themeData, int additionalDevicePixelRatio);
