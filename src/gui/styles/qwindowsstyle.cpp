...
{
	return QHighDpiScaling::factor(QApplicationPrivate::platform_integration->primaryScreen());
}
...
qreal QWindowsStylePrivate::devicePixelRatio(const QWidget *widget /*= 0*/)
{
	return widget ? widget->devicePixelRatioF() : QWindowsStylePrivate::appDevicePixelRatio();
}

qreal QWindowsStylePrivate::nativeMetricScaleFactor(const QWidget *widget /*= Q_NULLPTR*/)
{
