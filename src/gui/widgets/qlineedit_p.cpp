...
int QLineEditPrivate::verticalMargin(1);
int QLineEditPrivate::horizontalMargin(2);

Q_GUI_EXPORT void setQLineEditDefaultMargin(int vertical, int horizontal)
{
    QLineEditPrivate::verticalMargin = vertical;
    QLineEditPrivate::horizontalMargin = horizontal;
}
