...
/*!
    ...
    Return a QPixmap for cache.
*/
QPixmap _q_createCachePixmap(QSize sz)
{
    const QImage::Format pixmapFormat = QNativeImage::systemFormat() != QImage::Format_RGB16 ? QNativeImage::systemFormat() : QImage::Format_ARGB32_Premultiplied;
    QImage img(sz, pixmapFormat);
    return QPixmap::fromImage(img, Qt::AutoColor | Qt::NoFormatConversion);
}
                                                 ...
                                                 QGraphicsEffect::PixmapPadMode mode) const
{
    ...
    QPixmap pixmap = _q_createCachePixmap(effectRect.size());
