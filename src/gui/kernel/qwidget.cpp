...
QWidget::~QWidget()
{
    ...
    // [Add Begin] by dongqiongkang, When deleting completed, the activeWindow is already this widget, set the activeWindow to NULL
    if (this == QApplication::activeWindow())
        QApplicationPrivate::active_window = NULL;
    // [Add End]
}
